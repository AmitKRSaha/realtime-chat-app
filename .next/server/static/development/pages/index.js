...
function (_Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      this.pusher = new pusher_js__WEBPACK_IMPORTED_MODULE_2___default.a("ee7ecda76077fe82044a", {
        cluster: "ap2",
        encrypted: true
      });
...
function (_Component) {
  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      }, user && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Chat__WEBPACK_IMPORTED_MODULE_1__["default"], {
        activeUser: user
      })))));
    }
  }]);
